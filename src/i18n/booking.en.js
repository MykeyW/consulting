...
export const bookingEn = {
  ...
  booking_admin_status_completed: "Completed",
  booking_admin_status_noshow: "No-show",
  booking_admin_status_cancelled: "Cancelled",
  booking_admin_status_rescheduled: "Rescheduled",
  booking_admin_mark_completed: "Mark completed",
  booking_admin_mark_noshow: "Mark no-show",
  booking_admin_recovery: "Recovery",

  booking_noshow_followups_title: "No-show follow-ups",
  booking_noshow_followups_empty: "No no-shows waiting right now.",
  booking_noshow_followups_open: "Open",
  booking_noshow_followups_done: "Done",
  booking_noshow_followups_more: "More items exist (demo).",

  booking_noshow_drawer_title: "No-show recovery",
  booking_noshow_followup_open_badge: "Follow-up: Open",
  booking_noshow_followup_done_badge: "Follow-up: Done",
  booking_noshow_customer: "Customer",
  booking_noshow_auto_message: "Auto message",
  booking_noshow_sent: "Sent (demo)",
  booking_noshow_not_sent: "Not sent",
  booking_noshow_channel: "Channel",
  booking_noshow_channel_sms: "SMS",
  booking_noshow_channel_email: "Email",
  booking_noshow_subject: "Subject",
  booking_noshow_message_fallback: "Message preview unavailable.",
  booking_noshow_scheduled_send: "Scheduled send",
  booking_noshow_send_now: "Send now",
  booking_noshow_mark_followup_done: "Mark follow-up done",
  booking_noshow_mark_rescheduled: "Mark rescheduled",
  booking_noshow_close: "Close",
  booking_noshow_followup_task: "Follow-up task",
  booking_noshow_followup_call_title: "Call / reschedule",
  booking_noshow_due: "Due",
  booking_noshow_no_followup: "No follow-up task for this booking.",
  booking_noshow_demo_note:
    "Demo: in a real system this would text/email the client and create a task for staff.",
  booking_admin_needs_followup_badge: "Needs follow-up",

  booking_noshow_drawer_title: "No-show recovery",
  booking_noshow_message_label: "Auto message",
  booking_noshow_channel_sms: "SMS",
  booking_noshow_send_now: "Send now",
  booking_noshow_sent_button: "Sent",
  booking_noshow_badge_sent: "Sent (simulated)",
  booking_noshow_badge_not_sent: "Not sent",
  booking_noshow_demo_note:
    "Demo: in a real system this would send an SMS and log it in the client record.",
  booking_noshow_guest_fallback: "(Demo guest)",
  booking_close: "Close",
  booking_noshow_sms_template:
    "Hi {name} — we missed you for your appointment with {brand} on {date} at {time}. Want to reschedule? Reply YES and we’ll send times.",
};
